    ...
    <div className=" bg-[#FFF8E7]/80 backdrop-blur-md border-b border-[#ffffff]/30">
      ...
      <footer className="footer text-base-content border-base-300 border-t px-10 py-4">
        <aside className="grid-flow-row items-center">
          <a className="text-2xl font-bold bg-linear-to-r from-[#FF7B00] via-[#FF3D54] to-[#7CB518] bg-clip-text text-transparent">
            FlavorHood
          </a>
          <p className="italic">Where Every Bite Tells a Story</p>
        </aside>
